...
public class CrutdActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crutd);
        mapView = findViewById(R.id.mapView);
        app = findViewById(R.id.app_crutd);
        ...
        butNav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String strUri = "http://maps.google.com/maps?q=loc: 19.957084810657157, 99.87462290000002 (Label which you want)";
        ...
        butNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CrutdActivity.this, CrutdActivity2.class);
                startActivity(intent);
            }
        });
    }
