...
public class SpcActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        butNav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String strUri = "http://maps.google.com/maps?q=loc: 13.58003344980604, 100.79455033862546 (Label which you want)";
        ...
        butNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SpcActivity.this, SpcActivity2.class);
                startActivity(intent);
            }
        });
    }
