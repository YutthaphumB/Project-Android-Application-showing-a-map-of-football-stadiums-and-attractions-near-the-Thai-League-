...
public class PolfcActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_polfc);
        mapView = findViewById(R.id.mapView);
        app = findViewById(R.id.app_polfc);
        ...
        butNav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String strUri = "http://maps.google.com/maps?q=loc: 13.867335384497, 100.57813072796277 (Label which you want)";
        ...
        butNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PolfcActivity.this, PolfcActivity2.class);
                startActivity(intent);
            }
        });
    }
