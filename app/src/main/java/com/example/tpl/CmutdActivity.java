...
public class CmutdActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cmutd);
        mapView = findViewById(R.id.mapView);
        app = findViewById(R.id.app_cmutd);
        ...
        butNav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String strUri = "http://maps.google.com/maps?q=loc: 18.83990818421151, 98.95934668183759 (Label which you want)";
        ...
        butNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CmutdActivity.this, CmutdActivity2.class);
                startActivity(intent);
            }
        });
    }
