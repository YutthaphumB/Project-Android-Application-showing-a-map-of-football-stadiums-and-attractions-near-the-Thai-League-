...
public class TpfcActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tpfc);
        mapView = findViewById(R.id.mapView);
        app = findViewById(R.id.app_tpfc);
        ...
        butNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TpfcActivity.this, TpfcActivity2.class);
                startActivity(intent);
            }
        });
    }
