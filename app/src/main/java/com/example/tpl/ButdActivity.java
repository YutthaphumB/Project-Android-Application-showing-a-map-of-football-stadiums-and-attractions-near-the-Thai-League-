...
public class ButdActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_butd);
        mapView = findViewById(R.id.mapView);
        app = findViewById(R.id.app_butd);
        ...
        butNav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String strUri = "http://maps.google.com/maps?q=loc: 14.068227724092042, 100.59889153936543 (Label which you want)";
        ...
        butNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ButdActivity.this, ButdActivity2.class);
                startActivity(intent);
            }
        });
    }
