...
public class ChonActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        app = findViewById(R.id.app_chon);
        ...
        butNav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String strUri = "http://maps.google.com/maps?q=loc: 13.365545661125605, 100.976578 (Label which you want)";
        ...
        butNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ChonActivity.this, ChonActivity2.class);
                startActivity(intent);
            }
        });
    }
